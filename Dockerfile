...
ARG user_apache_id=1000
ARG group_apache_id=1000

RUN addgroup --gid $user_apache_id apache
RUN adduser --uid $group_apache_id --gid 1000 --no-create-home --disabled-password --gecos '' apache
